					...
					$.ajax({
						...
						, success: function(content){ 
							if (content=="SUCC") {
								...
								var strHtml = "<h2><img src=\"/images/pages/tit_login2.jpg\" alt=\"아이디 또는 비밀번호 오류입니다.\" /></h2>";
								strHtml += "<p class=\"alignC pt10\"><img src=\"/images/pages/txt_login2.jpg\" alt=\"현재 입력하신 아이디가 HC Recruit에 등록되어있지 않거나 아이디 또는 비밀번호를 잘못입력하셨습니다.\" /></p>";
			...
			<div class="contents">
				...
				<div class="loginForm">
					<p class="txt">
						...
						<input type="text" name="txtID" id="txtID" title="아이디" value="<%=Request.Cookies.Item("UserID")%>" maxlength="15" style="ime-mode:disabled;"/>
					</p>
					<p class="txt">
