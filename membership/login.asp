					...
					$.ajax({
						...
						, success: function(content){ 
							...
							if (Ref[0]=="SUCC") {
								...
								strHtml += "<p class=\"alignC pt10\"><img src=\"/images/pages/txt_login2_n01.jpg\" alt=\"현재 입력하신 아이디가 등록되어있지 않거나 아이디 또는 비밀번호를 잘못입력하셨습니다.\" /></p>";
								$("#divLoginMsg").html(strHtml);
								$("#txtPwd").val('');

									if(Ref[1] > 1){
										var cnt = 6 - parseInt(Ref[1]);
										alert("로그인 시도 횟수 "+cnt+"회 남았습니다.");
									}
								}
		...
		<div id="container">
			<div class="contents">
				...
				<div class="section1">
					...
					<p class="gojoin">
						<img src="/images/pages/txt_login_02.jpg" alt="아직 회원이 아니신가요? 간편가입하세요!" /> <br /><a href="/membership/easySignUp_n.asp"><img src="/images/pages/txt_login_03_n.jpg" alt="간편회원가입하기" /></a>
					</p>
					<p class="note">
