...
<%
	...
	Dim CrBYear_1, CrBMonth_1, CrEYear_1, CrEMonth_1, Reason_1, CompanyName_1, Department_1, Task_1, Position_1, CompanyYear_1
	Dim CrBYear_2, CrBMonth_2, CrEYear_2, CrEMonth_2, Reason_2, CompanyName_2, Department_2, Task_2, Position_2, CompanyYear_2
	Dim CrBYear_3, CrBMonth_3, CrEYear_3, CrEMonth_3, Reason_3, CompanyName_3, Department_3, Task_3, Position_3, CompanyYear_3
	...
	Sub getParamReq()
		...
		CrBYear_1		= FN_Req("CrBYear_1","")
		CrBMonth_1		= FN_Req("CrBMonth_1","")
		CrEYear_1		= FN_Req("CrEYear_1","")
		CrEMonth_1		= FN_Req("CrEMonth_1","")
		Reason_1		= FN_Req("Reason_1","")
		CompanyName_1	= FN_Req("CompanyName_1","")
		Department_1	= FN_Req("Department_1","")
		Task_1			= FN_Req("Task_1","")
		Position_1		= FN_Req("Position_1","")
		CompanyYear_1	= FN_Req("CompanyYear_1","")

		CrBYear_2		= FN_Req("CrBYear_2","")
		CrBMonth_2		= FN_Req("CrBMonth_2","")
		CrEYear_2		= FN_Req("CrEYear_2","")
		CrEMonth_2		= FN_Req("CrEMonth_2","")
		Reason_2		= FN_Req("Reason_2","")
		CompanyName_2	= FN_Req("CompanyName_2","")
		Department_2	= FN_Req("Department_2","")
		Task_2			= FN_Req("Task_2","")
		Position_2		= FN_Req("Position_2","")
		CompanyYear_2	= FN_Req("CompanyYear_2","")

		CrBYear_3		= FN_Req("CrBYear_3","")
		CrBMonth_3		= FN_Req("CrBMonth_3","")
		CrEYear_3		= FN_Req("CrEYear_3","")
		CrEMonth_3		= FN_Req("CrEMonth_3","")
		Reason_3		= FN_Req("Reason_3","")
		CompanyName_3	= FN_Req("CompanyName_3","")
		Department_3	= FN_Req("Department_3","")
		Task_3			= FN_Req("Task_3","")
		Position_3		= FN_Req("Position_3","")
	...
	Sub getParamObj()
		...
		With clsObjUpload
			...
			CrBYear_1		= FN_StrInj(.getReq("CrBYear_1"))
			CrBMonth_1		= FN_StrInj(.getReq("CrBMonth_1"))
			CrEYear_1		= FN_StrInj(.getReq("CrEYear_1"))
			CrEMonth_1		= FN_StrInj(.getReq("CrEMonth_1"))
			Reason_1		= FN_StrInj(.getReq("Reason_1"))
			CompanyName_1	= FN_StrInj(.getReq("CompanyName_1"))
			Department_1	= FN_StrInj(.getReq("Department_1"))
			Task_1			= FN_StrInj(.getReq("Task_1"))
			Position_1		= FN_StrInj(.getReq("Position_1"))
			CompanyYear_1	= FN_StrInj(.getReq("CompanyYear_1"))

			CrBYear_2		= FN_StrInj(.getReq("CrBYear_2"))
			CrBMonth_2		= FN_StrInj(.getReq("CrBMonth_2"))
			CrEYear_2		= FN_StrInj(.getReq("CrEYear_2"))
			CrEMonth_2		= FN_StrInj(.getReq("CrEMonth_2"))
			Reason_2		= FN_StrInj(.getReq("Reason_2"))
			CompanyName_2	= FN_StrInj(.getReq("CompanyName_2"))
			Department_2	= FN_StrInj(.getReq("Department_2"))
			Task_2			= FN_StrInj(.getReq("Task_2"))
			Position_2		= FN_StrInj(.getReq("Position_2"))
			CompanyYear_2	= FN_StrInj(.getReq("CompanyYear_2"))

			CrBYear_3		= FN_StrInj(.getReq("CrBYear_3"))
			CrBMonth_3		= FN_StrInj(.getReq("CrBMonth_3"))
			CrEYear_3		= FN_StrInj(.getReq("CrEYear_3"))
			CrEMonth_3		= FN_StrInj(.getReq("CrEMonth_3"))
			Reason_3		= FN_StrInj(.getReq("Reason_3"))
			CompanyName_3	= FN_StrInj(.getReq("CompanyName_3"))
			Department_3	= FN_StrInj(.getReq("Department_3"))
			Task_3			= FN_StrInj(.getReq("Task_3"))
			Position_3		= FN_StrInj(.getReq("Position_3"))
