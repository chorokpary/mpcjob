...
'
' * Discription : fine.asp / HC - 비밀번호 조회
' 
...
<html lang="ko">
<head>
	<title>아이디 비밀번호찾기 - HANKOOK CORPORATION</title>
				...
				<div class="findForm clearfix">
					<div class="fl_l">
						...
						<div class="note">
							...
							<img src="/images/pages/txt_find_02_n01.jpg" alt="ID 는 휴대폰 번호 입니다. (-포함 입력 예시: 010-1234-5678)" /><br />
							<img src="/images/pages/txt_find_03.jpg" alt="아이디가 생각나지 않으시거나 휴대폰번호를 변경하신 경우 HC문의센터 02-3432-6100로 문의 주시기 바랍니다." />
						</div>
					</div>
					<div class="fl_r">
						...
						<form id="frmFind" name="frmFind" method="post" onsubmit="javascript: return chkForm();">
							<p class="txt">
								...
								<input type="text" name="txtID" id="txtID" title="아이디" maxlength="15" style="ime-mode:disabled;" placeholder="휴대폰번호 - 포함하여 입력"/>
							</p>
							<p class="txt">
