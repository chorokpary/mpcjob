	...
	<div class="inner"><div class="inner2">
		<div class="popCont easySignUp">
			...
			<p class="note">
				...
				<img src="/images/pages/txt_easyRecruite_04.jpg" alt="지원서 저장시 자동으로 히ㅗ원가입됩니다.(ID : 휴대폰번호)" /><br />
				<img src="/images/pages/txt_easyRecruite_05.jpg" alt="지원서 저장시 자동 로그인 됩니다." />
			</p>
			<% End If %>
