...
<body>
	<div id="wrap" class="main">
		<!--#include virtual="/common/include/top_t.asp"-->
		<div id="container">
			<!-- 플래시영역 //-->
			<div class="topRight">
				 ...
				 <div class="new_bottom">
					<ul>
						...
						<div>
							...
							<p class="pNumber">hr@besthc.co.kr</p>
						</div>
						</li>
						<li class="kakao">
						<div>
							...
							<p class="pNumber"><a href="http://pf.kakao.com/_zxbPrj/chat" class="kakao" target="_blank">한국코퍼레이션</a></p>
						</div>
						</li>
						<li>
						<div>
