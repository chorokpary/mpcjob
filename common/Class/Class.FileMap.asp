...
Class ClsFileMap
	...
	Public Function getLocation(argDicKey)
		...
		If IsArray(DicMenuCode(strDicKey)) Then
			Select Case Left(strMenuCode,2)
				...
				Case "02" :	strLoc = strLoc & "<a href=""/family/family.asp"">Family</a>"
				Case "03" :	strLoc = strLoc & "<a href=""/corp/philosophy.asp"">About</a>"
				Case "04" :	strLoc = strLoc & "<a href=""/inform/notice_list.asp"">알리미</a>"
	...
	Public Sub setInitDicAdmin ()
		...
		Call DicMenuCode.Add("/admin/stats/stats_recruit.asp", Array("050200","HC회원 채용통계\t","1"))
		Call DicMenuCode.Add("/admin/stats/stats_recruit_xls.asp", Array("050200","HC회원 채용통계\t","1"))
