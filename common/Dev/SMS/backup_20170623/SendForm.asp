...
<script type="text/javascript">
	function chkForm(){
		...
		*/
		...
		//$("#Flag").val("ANS");
		$("#frmSms").attr({action:"/common/Dev/SMS/SendProc.asp", method:"post"});
	...
	<div class="writeSms">
		...
		<div class="inner send clearfix">
			<div class="fl_l inputArea">
				<input type="radio" name="ReservedChk" id="ReservedChk_N" value="0" checked /><label for="ReservedChk_N">즉시발송</label>
				<input type="radio" name="ReservedChk" id="ReservedChk_Y" value="1" /><label for="ReservedChk_Y">예약발송</label>
				<p>
