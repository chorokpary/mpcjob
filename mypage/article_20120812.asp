...
<head>
	...
	<script type="text/javascript">
		function chkForm(){
			if (!$("#chk_consent1").attr("checked")){
				alert("서비스 약관에 동의하셔야 합니다.");
				return false;
			}
			
			if (!$("#chk_consent2").attr("checked")){
...
<body>
	<div id="wrap" class="resumeMng">
		<!--#include virtual="/common/include/top.asp"-->
		<div id="container">
			<div class="contents">
				<div class="clearfix bread">
					<div class="fl_l">
						<h2><img src="/images/pages/tit_resumeMng.jpg" alt="공지사항" /></h2>
					</div>
					<div class="fl_r">
						<p><%=GNB_STR_LOC%></p>
					</div>
				</div>
				<div class="boxArea height83">
					<h3>회원 이용약관</h3>
					<p>아래 서비스약관 및 개인정보수집동의 안내에 대해 반드시 읽어보시고, 내용에 동의하시면 체크 후 동의하기 버튼을 눌러주세요!</p>
				</div>
				<form id="frmAgree" name="frmAgree" action="article_proc.asp" onsubmit="javascript : return chkForm();">
				...
				<div class="inner_txt">
					...
					<h4>01. 개인정보 수집항목 및 수집방법</h4>
					<p>회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.</p>
					<ul>
						<li>1) 수집항목
							<p>&nbsp;&nbsp;&nbsp;&nbsp;이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택 주소 , 휴대전화번호 , 이메일 , 주민등록번호 , 경력, 학력, 가족, 쿠키 등</p>
						</li>
						<li>2) 개인정보 수집방법 : MPCJOB의 회원가입과 채용포털사이트 온라인접수, 이메일로 수집하고 있습니다.</li>
					</ul>
					<h4>02. 개인정보의 수집목적 및 이용목적</h4>
					<p>㈜엠피씨는 "개인정보 수집에 대한 동의 및 수집방법" 의 회원가입에 따라 대부분의 콘텐츠에 자유롭게 접근할 수 있으며, 필수항목을 입력하여야 하며 선택항목을 입력하지 않더라도 서비스 이용에 제한을 두지 않습니다.</p>
					<ul>
						<li>1) 회원가입 시 수집하는 개인정보의 범위 :
							<p>&nbsp;&nbsp;&nbsp;&nbsp;이름, 주민등록번호, 현주소, 최종학력, 실제생년월일, 취업경력, 휴대폰번호, E-mail, 이력서사진</p>
						</li>
						<li>2) 이력서 등록시 수집하는 개인정보의 범위 : 
							<p>&nbsp;&nbsp;&nbsp;&nbsp;학력사항, 경력사항, 가족사항, 자기소개서, 경력기술서</p>
						</li>
					</ul>
					<h4>03. 개인정보의 보유 및 이용기간</h4>
					<p class="txtBr">이용자가 회사의 회원으로서 회사에 제공하는 서비스를 이용하는 동안 회사는 이용자들의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다.  다만, 개인정보취급방침의 "07. 이용자 자신의 개인정보 관리(열람,정정,삭제등)에 관한 사항" 에서 설명한 절차와 방법에 따라 회원 본인이 직접 삭제하거나 수정한 정보, 가입해지를 요청한 경우에는 재생할 수 없는 방법에 의하여 디스크에서 완전히 삭제하며 추후 열람이나 이용이 불가능한 상태로 처리됩니다.</p>
					<p class="txtBr">그리고 "01. 개인정보 수집항목 및 수집방법"에서와 같이 일시적인 목적 (설문조사, 이벤트, 본인확인 등)으로 입력 받은 개인정보는 그 목적이달성된 이후에는 동일한 방법으로 사후 재생이 불가능한 상태로 처리됩니다.<br /><br />
					귀하의 개인정보는 다음과 같이 개인정보의 수집목적 또는 제공받은 목적이 달성되면 파기하는 것을 원칙으로 합니다. 다만, 회사는 불량 회원의 부정한 이용의 재발을 방지하기 위해, 이용계약 해지일로부터 1년간 해당 회원의 주민등록번호를 보유할 수 있습니다. 그리고 상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계법령의 규정에 의하여 보존할 필요가 있는 경우 회사는 관계법령에서 정한 일정한 기간 동안 회원정보를 보관합니다. 이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용하며 보존기간은 아래와 같습니다.</p>
					<ul>
				...
				<p class="resumeBtn"><input id="consent" type="image" alt="약관동의" src="/images/pages/btn_resumeMng.jpg" name="약관동의" /></p>
				</form>
			</div>
