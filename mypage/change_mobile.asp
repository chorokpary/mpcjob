...
<script type="text/javascript">
	...
	function doChkMobile() {
		...
		var url = "http://www.mpcjob.co.kr/common/dev/ajax/check_exists_userid.asp";
	...
	function doModSubmit(){
		var url = "https://www.mpcjob.co.kr/mypage/change_proc.asp"
