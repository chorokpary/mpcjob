						...
						<table class="tblForm alignC">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									<input type="text"  title="입사년도" value="<% If arrData(1,i) <> "" And arrData(2,i) <> "" Then %><%=arrData(1,i)%><%=arrData(2,i)%><% End If %>" class="w50" readonly />~
									<input type="text"  title="입사년도" value="<% If arrData(3,i) <> "" And arrData(4,i) <> "" Then %><%=arrData(3,i)%><%=arrData(4,i)%><% End If %>" class="w50" readonly />
											<% 
											
											If arrData(1,i) <> "" And arrData(3,i) <> ""  Then 
												 Dim mon
												 mon = CInt(DateDiff("M", ""&arrData(1,i)&"-"&arrData(2,i)&"-01",""&arrData(3,i)&"-"&arrData(4,i)&"-01"))
											%>
								...
								<tr>
									...
									<td class="alignC"><input type="text" id="CompanyName" name="CompanyName" title="직장명" value="" class="w60" maxlength="20" /></td>
									<td class="alignC"><input type="text" id="Department" name="Department" title="부서" value="" class="w60" maxlength="15" /></td>
									<td><input type="text" id="Task" name="Task" name="Task" title="업무" value="" class="w60" maxlength="15" /></td>
									<td><input type="text" id="Reason" name="Reason" name="Reason" title="퇴사사유" value="" class="w60" maxlength="25" /></td>
								</tr>
							</tbody>
						</table>
