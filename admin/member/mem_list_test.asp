...
<%
	...
	Dim selPartnerD1_1, PartnerDepth2, selPartnerD1_1_txt
	...
	Sub Main()
		...
		selPartnerD1_1 = FN_ReqF("selPartnerD1_1","")
		PartnerDepth2   = FN_ReqF("PartnerDepth2","")

		Select Case selPartnerD1_1
		case "26"
		selPartnerD1_1_txt = "이메일"
		case "7"
		selPartnerD1_1_txt = "서칭"
		case "6"
		selPartnerD1_1_txt = "인력업체"
		case "5"
		selPartnerD1_1_txt = "온라인광고"
		case "3"
		selPartnerD1_1_txt = "내부추천"
		case "2"
		selPartnerD1_1_txt = "MPCJOB"
		case else
		selPartnerD1_1_txt = ""
		end select

		
		response.write "selPartnerD1_1 = " & selPartnerD1_1 & "<br>"
		response.write "selPartnerD1_1_txt = " & selPartnerD1_1_txt & "<br>"
		response.write "PartnerDepth2 = " & PartnerDepth2 & "<br>"
	...
	Sub getList2()
		...
		If selPartnerD1_1 <> "" Then 	Sql_Where = Sql_Where & " AND AI.PartnerDepth1 = ? "
...
'			.Parameters.Refresh
			...
			If selPartnerD1_1 <> "" Then	.Parameters.Append .CreateParameter("PartnerDepth1", adVarWChar, adParamInput, 30, selPartnerD1_1_txt)
	...
	<script type="text/javascript">
		...
		function getPartner_search(){
			...
			$.ajax({
				...
				, url: url
				, data: param
				, success: function(content){ $("#divPartner_1").html(content) }
				, error: function(xhr, status, error) {alert("[Rec] " + error);}
			});
		}

		function getPartner_search2(parent){
			var url = "/common/dev/ajax/make_select_partner.asp";
			var param = "Parent=" + parent + "&TargetID=PartnerDepth2";
			$.ajax({
				type: "POST"
				, url: url
				, data: param
		...
		$(function() {
			...
			if( $("#selPartnerD1_1").val() == "5" || $("#selPartnerD1_1").val() == "6"){
				  getPartner_search2($("#selPartnerD1_1").val());
		...
		<div class="contents2">
			...
			<div class="right">
				...
				<div id="contArea">
					...
					<form name="frmPage" id="frmPage" method="post" action="mem_list_test.asp">
						...
						<div class="search_detail pt10">
							<div class="fl_l">
								...
								<span class="group">
									...
									response.write " ": Call SB_MakeHTMLSelect(objDBCon, PartnerSql, "selPartnerD1_1", "ROOT", "", selPartnerD1_1, "", " class=""w100""", False)
									%>
