...
<%
	...
	' ########## DB 연동 SELECT BOX 출력
	Sub SB_MakeHTMLSelect_test(argObjDB, strSQL, argName, argDefaultOpt, argDefaultVal, argSelectVal, argNullMsg, argScript, argIsUrlEncode)
			...
			<div class="right">
				...
				<div id="contArea" class="<%=Fn_SetDefault(Flag,"ADD","job_reg","mem_info")%>">
					...
					<div class="searchArea">
						...
						<%
						'SB_MakeHTMLSelect_test(argObjDB, strSQL, argName, argDefaultOpt, argDefaultVal, argSelectVal, argNullMsg, argScript, argIsUrlEncode)

						Dim AdmListSql : AdmListSql = "Execute uspAdm_List @Flag = 'ADM', @pno = '1', @per_page = '50', @sKey = '', @sWord = '', @sLevel = '1' " 
						response.write " ": Call SB_MakeHTMLSelect_test(objDBCon, AdmListSql, "AdminList_1", "", "", Session("ASeq"), "", " class=""w100""", False)
						%>
