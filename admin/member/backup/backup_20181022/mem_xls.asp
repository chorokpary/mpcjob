...
<%
	...
	Sub getList()
		...
		Else
			...
			kFields 	= Array("UsrSeq","UsrID","UsrName","Gender","Birthday","Addr","AddrDetail","Mobile","Email","HopePart","RegDate","ModDate","IsBlack","CntMemo","Status","PartnerDepth1","PartnerDepth2","PrjName","strEzCareer")
...
<table x:str border=1 cellpadding=0 cellspacing=0 >
	...
	<tr height=26 style='mso-height-source:userset;'>
		...
		<td align="center" <%=strStyle%>><%= arrData(7,i) %></td>
	...
	<tr height=26 style='mso-height-source:userset;height:20.1pt'>
		<td align="center" colspan="13">선택된 회원 정보가 없습니다.</td>
	</tr>
	<%
	End If
	%>	
