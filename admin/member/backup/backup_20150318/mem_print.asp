		...
		<div id="contArea">
			<div class="<%=Fn_SetDefault(k,0,"","printSec")%> pb50">
				...
				<div >
							...
							<table class="tblForm">
								...
								<tbody>
									...
									<tr>
										...
										<th colspan="6" class="alignL pl5"><% If arrLen > -1 Then %>최종학력 : <%=strFinEdu%> <% End If %></th>
									</tr>
									<tr>
										<th>입학년월</th>
										<th>졸업년월</th>
						...
						<div class="tblArea">
							...
							<table class="tblForm">
								...
								<tbody>
									...
									%>
									<tr>
										<td class="alignC"><%=strCarDt%></td>
										<td><%=strCarCNm%></td>
										<td class="alignC"><%=strCarPos%></td>
										<td class="alignC"><%=strCarDpt%></td>
										<td><%=strCarTask%></td>
										<td><%=strCarRs%></td>
									</tr>
									<% Next %>
					...
					<div class="infoSign">
						<div class="fl_l">
							<p>위 기재사항은 사실과 다름 없음.</p>
						</div>
						<div class="fl_r">
							<p><%'=FN_SetDateTimeFormat(RegDate,"YYYY년 MM월 DD일")%> 작성자 : <%=UsrName%></p>
						</div>
					</div>
				</div>
			</div>
