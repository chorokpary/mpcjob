...
'   #003 : 2014-12-16 / 이길홍 / 4M / 주민번호 수정항목 삭제
'____________________________________________________________________________________
%>
<%
	...
	Sub getData()
		...
		With objCmd
			...
			If Not Rs.Eof Then
				...
				kFields 	= Array("PrjName","Title","AppBDate","AppEDate","RegDate","AdmName","CdVal","RecrPart","RecrPart2","CancelDate", "RecrSeq","CntQues")
	...
	<script type="text/javascript">
		...
		function chkForm(){
			...
			*/
			...
			/*
			if ($("#frmInfo").find("#Flag").val()=="ADD"){
				$("#AddPartnerD1").val($("#PartnerDepth1").val());
				$("#AddPartnerD2").val($("#PartnerDepth2").val());
				$("#AddRecrSeq").val($("#RecrSeq").val());
			}
			*/
			$("#frmInfo").attr({action:"mem_proc.asp", method:"post", enctype:"multipart/form-data"}).submit();
		}
						...
						<table class="tblForm">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" id="Birthday" name="Birthday" title="생년월일" value="" class="w120" maxlength="6" style="ime-mode:disabled;" />
									</td>
							...
							<table class="tblForm">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="hidden" id="Birthday_Y" name="Birthday_Y" value="<%=Left(Birthday,4)%>">
											<input type="text" id="Birthday" name="Birthday" title="생년월일" value="<%=Right(Replace(Birthday,"-",""),6)%>" class="w120" maxlength="6" style="ime-mode:disabled;" />
									...
									<tr>
										...
										<td colspan="5">
											...
											<p id="pAttach_2"><a href="javascript:goDown('<%=Seq%>','USERS','Attach1_Path','<%=Attach2_FName%>');"><%=Attach2_FName%></a> <span class="btns btn_in"><a href="javascript:doDelFile('pAttach_2','DelAttach_2','<%=Attach2_Path%>')">삭제</a></span></p>
											<% End If %>
											<input type="file" id="Attach_2" name="Attach_2" title="첨부파일 2" value="" class="w660" size="95" /> 
									...
									<tr>
										...
										<td colspan="5">
											...
											<p id="pAttach_3"><a href="javascript:goDown('<%=Seq%>','USERS','Attach1_Path','<%=Attach3_FName%>');"><%=Attach3_FName%></a> <span class="btns btn_in"><a href="javascript:doDelFile('pAttach_3','DelAttach_3','<%=Attach3_Path%>')">삭제</a></span></p>
											<% End If %>
											<input type="file" id="Attach_3" name="Attach_3" title="첨부파일 3" value="" class="w660" size="95" /> 
									...
									<tr>
										...
										<td>
											...
											</span><span class="btns btn_in"><a href="#btnPwdSend" id="btnPwdSend">임시비밀번호 전송</a></span>
										</td>
									...
									<tr>
										<th><label for="Mobile"><span class="ess">*</span> 핸드폰번호</label></th>
										<td colspan="5">
											<input type="tel" id="Mobile" name="Mobile" title="핸드폰번호" value="<%=Mobile%>" class="w285" maxlength="13" style="ime-mode:disabled;" /> 
											<span class="btns btn_in"><a href="#btnChkMobile" id="btnChkMobile">중복체크</a></span>
											<input type="hidden" id="ChkMobile" name="ChkMobile" value="Y">
											<input type="hidden" id="OrgMobile" name="OrgMobile" value="<%=Mobile%>">
										</td>
									</tr>
									<tr>
