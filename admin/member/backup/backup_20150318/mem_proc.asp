...
<%
	...
	Dim Email, Zipcode1, Zipcode2, Intro
	Dim Passwd
	Dim ImgPath, ImgName
	...
	Sub Main()
		...
		If Flag = "DEL" Or Flag = "BLK" Or Flag = "RECR" Or Flag = "PWD_C" Or Flag = "PWD_S" _
			Or Flag = "EDU" Or Flag = "CAREER" Or Flag = "FAM" Or Flag = "MEMO" Or Flag = "QUES"  Then
	...
	' ### Career : Start
	Sub setCareerProc()
		Dim CrBYear, CrBMonth, CrEYear, CrEMonth, Reason, CompanyName, Department, Task, Position
