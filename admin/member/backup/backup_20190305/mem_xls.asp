...
<%
	...
	Sub getList()
		...
		Else
			...
			kFields 	= Array("UsrSeq","UsrID","UsrName","Gender","Birthday","Addr","AddrDetail","Mobile","Email","HopePart","RegDate","ModDate","IsBlack","CntMemo","Status","PartnerDepth1","PartnerDepth2","PrjName","strEzCareer","AddrSido","AddrGugun")
