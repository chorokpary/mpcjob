...
'
' * Discription : job_apply_user_xls.asp / 지원자 목록 다운로드
' 
...
<%
	...
	Sub getList()
		...
		Else
			...
			' Recommend_Num(18), Recommend_Name(19), Recommend_Center(20)
			kFields 	= Array("UsrSeq","UsrID","UsrName","Gender","Birthday","Addr","AddrDetail","Mobile","Email","RegDate","CntMemo","Status","PartnerDepth1","PartnerDepth2","AddrSido","AddrGugun","CancelDate","IsOut","Recommend_Num","Recommend_Name","Recommend_Center")
...
<table x:str border=1 cellpadding=0 cellspacing=0 >
	...
	<tr height=26 style='mso-height-source:userset;' <%=strAppCStyle%>>
		...
		<td align="center"><% If IsNumeric(Left(arrData(4,i),4)) Then %><%=Fn_GetAge(arrData(4,i))%><% Else %> - <% End If %></td>
		<td align="center">
			<%
		...
		<td align="center"><%= arrData(20,i) %></td>
	</tr>
	<%
		Next
	Else	
	...
	<tr height=26 style='mso-height-source:userset;height:20.1pt'>
		<td align="center" colspan="14">선택된 회원 정보가 없습니다.</td>
	</tr>
	<%
	End If
	%>	
