...
%>
	...
	<script type="text/javascript">
		...
		function chkForm(){
			...
			$("#frmInfo").attr({action:"job_proc.asp", method:"post", target:"_self", enctype:"multipart/form-data"}).submit();
		}
		...
		$(window).load(initPage);
					...
					<form id="frmInfo" name="frmInfo" action="job_proc.asp" method="post" >
						...
						<table class="tblForm">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" id="ChargePhone" name="ChargePhone" value="<%=ChargePhone%>" title="담당자 연락처" class="w155" maxlength="15" style="ime-mode:disabled;" /> 
									</td>
