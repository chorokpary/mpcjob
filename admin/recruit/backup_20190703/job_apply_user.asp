...
<%
	...
	Sub getList()
		...
		Else
			...
			' CntMemo(17), Status(18), CntAll(19), CntIng(20), CntFin(21), UsrType(22), Mobile(23), IsBlack(24), CancelDate(25), IsOut(26), CntStat(27)
			kFields 	= Array("TotalCnt","AppSeq","UsrSeq","PartnerDepth1","PartnerDepth2","RegDate","UsrName","Gender","Birthday","AddrSido","AddrGugun" _
							,"Attach1_Path","Attach1_FName","Attach2_Path","Attach2_FName","Attach3_Path","Attach3_FName","CntMemo","Status","CntAll","CntIng","CntFin","UsrType","Mobile","IsBlack","CancelDate","IsOut","CntStat")
