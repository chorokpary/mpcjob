...
<%
	...
	Sub getList()
		...
		Else
			...
			kFields 	= Array("UsrSeq","UsrID","UsrName","Gender","Birthday","Addr","AddrDetail","Mobile","Email","RegDate","CntMemo","Status","PartnerDepth1","PartnerDepth2","AddrSido","AddrGugun","CancelDate","IsOut")
...
<table x:str border=1 cellpadding=0 cellspacing=0 >
	...
	<tr height=26 style='mso-height-source:userset;height:20.1pt'>
		<td align="center" colspan="11">선택된 회원 정보가 없습니다.</td>
	</tr>
	<%
	End If
	%>	
