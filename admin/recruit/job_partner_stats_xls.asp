...
'
' * Discription : job_patner_stats_xls.asp / 통계관리 엑셀다운
' 
...
<%
	...
	Response.AddHeader "Content-Disposition","attachment; filename=MPC_APPLY_PARTNER_EXCEL.xls"
%>
<%
	Dim Seq, ViewFlag
	Dim kFields, i, j
	...
	Sub getData(argSeq)
		...
		Else
			...
			' Cnt00(8), Cnt01(9), Cnt02(10), Cnt03(11), Cnt04(12), Cnt05(13), Cnt06(13), Cnt07(15), Cnt08(16), Cnt09(17)
...
<head>
	...
	<title>MPC_APPLY_PARTNER_EXCEL</title>
	<style type="text/css">
...
<body link=blue vlink=purple>
	<h2><%=Fn_SetDefault(ViewFlag,"SING","개별통계","전체통계")%></h2>
