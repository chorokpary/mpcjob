...
'
' * Discription : notice_proc.asp / 게시판 정보 저장
' 
...
%>
<%
	Dim Flag, Seq, sKey, sWord
	Dim Subject, Passwd, Attach1_Path, Attach1_Name, Attach2_Path, Attach2_Name, Contents
	Dim Attach1, Attach2
	...
	Sub setResult()
		...
		If Result = 0 Then
			...
			If Flag = "ADD" Or Flag = "MOD" Then
				strScript = "window.location.href = ""notice_list.asp""; "
			Else
				strScript = "window.location.href = ""notice_list.asp?sKey=" & sKey & "&sWord=" & sWord & """; "
			End If
		Else
