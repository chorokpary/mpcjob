...
%>
		<div class="footer">
			<div class="inner"> <address><img src="/admin/images/footer_admin.gif" alt="서울시 영등포구 문래로20길 60 메가벤처타워 8F (주)한국코퍼레이션 / 대표전화 : 02-3432-6100 / COPYRIGHT (C) HANKOOK CORPORATIONINC. ALL RIGHTS RESERVED" /></address></div>
		</div>
