...
'
' * Discription : hiretype_list.asp / 고용형태 목록
' 
		...
		function chkIsUse(){
			if (cntChecked("#frmList")==0){
				...
				if(confirm("사용 여부를 변경하시겠습니까?")){
					$("#Flag").val("STA");
					$("#frmList").attr({action:"hiretype_proc.asp", method:"post"}).submit();
				}
			}
		}
				...
				<div id="contArea">
					...
					<div class="btnArea">
						...
						<div class="fl_r">
							...
							</span><span class="btns btn_b"><a href="#btnReg" id="btnReg">고용형태 등록</a></span>
						</div>
					</div>
