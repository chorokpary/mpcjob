...
<%
	...
	Sub setProc()
		...
		If StrComp("OK", returnMsg)= 0 Then
			...
			With objCmd
				...
				.Parameters("@AdmTel").Value 		= oSeed.Encrypt(AdmTel)
				.Parameters("@AdmMobile").Value 	= oSeed.Encrypt(AdmMobile)
	...
	Sub setResult()
		...
		If Result = 0 Then
			...
			If Flag = "ADD" Or Flag = "MOD" Or Flag = "PWD" Then
				strScript = "window.location.href = ""http://www.mpcjob.co.kr/admin/siteconf/adm_proc.asp?H_SSL=Y""; "
