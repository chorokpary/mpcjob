		...
		<div id="container">
			...
			<div class="contents">
				...
				<div class="bottom clearfix">
					<div class="inner2">
						<h2><img src="/images/main/stit_main_06_1.png" alt="이력서 양식 다운로드" /></h2>
						<p> 
							...
							<a href="/common/Dev/FileDown.asp?dnSeq=0&dnFld=ConfFormDoc&dnFlag=STATIC&dnFName=SK매직_이력서.xls">SK매직_이력서</a>
						</p>
					</div>
					<div class="inner3">
						<h2><img src="/images/main/stit_main_07_1.png" alt="한국코퍼레이션 채용문의" /></h2>
