    ...
    $('#frmJoin').ajaxForm({
            ...
            success: function(response,status){
				...
				if (response=="SUCC") {
					...
					openLayer("/recruit/apply_proc_t.asp",param+"&NextAction=APPLY", "w668");
					<% End If %>
			...
			<div class="inner"><div class="inner2">
				<div class="popCont easySignUp">
					...
					<div class="inner_txt">
						...
						(주)한국코퍼레이션은 개인정보보호법, 정보통신망 이용 촉진 및 정보보호 등에 관한 법률 등 관련 법령상의 개인정보보호 규정을 준수하며, 지원자의 개인정보보호에 최선을 다하고 있습니다.<br />
