    ...
    $('#frmJoin').ajaxForm({
            ...
            success: function(response,status){
				...
				if (response=="SUCC") {
					...
					<% Else %>
					openLayer("/recruit/apply_proc.asp","RecrSeq=<%=RecrSeq%>&NextAction=APPLY", "w668");
					<% End If %>
		...
		<div id="container">
			...
			<div class="inner"><div class="inner2">
				<div class="popCont easySignUp">
					...
					<div class="inner_txt">
						<h4>제1조 (목적)</h4>
						<p>본 약관은 주식회사 엠피씨에서 운영하는 취업정보 서비스에 대한 회원제도에 대한 제반사항을 규정하는데 목적이 있습니다.</p>
						<h4>제2조 (정의)</h4>
					...
					<div class="inner_txt">
						...
						㈜엠.피.씨는 개인정보보호법, 정보통신망 이용 촉진 및 정보보호 등에 관한 법률 등 관련 법령상의 개인정보보호 규정을 준수하며, 지원자의 개인정보보호에 최선을 다하고 있습니다.<br />
						MPCJOB 사이트 내에서 주민등록번호를 취득하거나 이용하지 않습니다.<br />
						MPCJOB의 기가입자의 주민등록번호는 모두 폐기합니다.<br />
						MPCJOB은 개인식별을 위하여 이름/생년월일/휴대폰전화번호를 주민등록번호의 대체수단으로 이용합니다.<br />
						MPCJOB 사이트는 본인의 동의 없이 개인정보를 수집 및 활용하거나 제3자에게 제공하지 않습니다.<br />
						<h4>제1조 개인정보의 수집 및 이용목적</h4>
							(주)MPC에서 운영하는 고객센터의 채용 지원과 자격요건의 확인 및 원활한 채용 진행, 진행단계별 결과, 채용관련 정보를 안내하기 위함.
